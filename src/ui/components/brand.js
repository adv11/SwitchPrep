...
// issue #206 §7 — the "teal/cyan" fill this comment used to describe is now
// var(--gradient-alpenglow) (gold->rose, .brand-mark, app.css), matching the
// Progress page's ring stroke. No change needed here in the glyph itself —
// it was already currentColor, driven entirely by .brand-mark's CSS.
